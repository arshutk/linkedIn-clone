...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('userprofile', '0003_auto_20201105_2307'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='test_organization', to='userprofile.organization')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='test', to='userauth.userprofile')),
            ],
            options={
                'verbose_name': 'TestScore',
                'verbose_name_plural': 'TestScores',
            },
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('project_url', models.URLField(blank=True, null=True)),
                ('description', models.TextField()),
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_organization', to='userprofile.organization')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project', to='userauth.userprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certification', to='userauth.userprofile')),
            ],
            options={
