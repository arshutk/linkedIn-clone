...
class WorkExperience(models.Model):
    ...
    user                = models.ForeignKey(UserProfile, on_delete = models.CASCADE, related_name ='work')
...
class LicenseAndCertification(models.Model):
    ...
    user                = models.ForeignKey(UserProfile, on_delete = models.CASCADE, related_name ='certification')
...
class Project(models.Model):
    ...
    user                = models.ForeignKey(UserProfile, on_delete = models.CASCADE, related_name ='project')
