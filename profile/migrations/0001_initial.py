    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_academic', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='current_academic', to='profile.education')),
                ('current_organization', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='current_work', to='profile.workexperience')),
