    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_type', models.CharField(choices=[('Fulltime', 'Full-Time'), ('Parttime', 'Part-Time'), ('Internship', 'Internship'), ('Contract', 'Contract')], max_length=50)),
                ('description', models.TextField(blank=True)),
                ('file_linked', models.FileField(blank=True, max_length=1048576, null=True, upload_to='user/jobs')),
                ('skills_required', models.CharField(blank=True, max_length=30, null=True)),
                ('is_closed', models.BooleanField(default=False)),
                ('posted_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='posted_jobs', to='userauth.userprofile')),
